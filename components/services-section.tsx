      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <motion.div className="flex justify-center" variants={imageVariants} initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }}>
            <img src="/service.jpg" alt="Spiritual harmony and balance achieved through Vastu principles" className="w-full h-auto max-w-xl rounded-full shadow-xl object-cover" />
          </motion.div>
