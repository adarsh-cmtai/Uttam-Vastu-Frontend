...
const packages = [
  {
    title: "1 Site Visit",
    price: "₹ 3,000",
    description: "Half-day real client site visit with practical Vastu analysis.",
  },
  {
    title: "2 Site Visits",
    price: "₹ 5,000",
    description: "Two locations, with flexible scheduling options.",
  },
  {
    title: "3 Site Visits",
    price: "₹ 6,000",
    description: "Three locations, with flexible scheduling options.",
  },
]
      ...
      <div className="py-16">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <div className="flex justify-center items-center gap-2 text-sm font-medium drop-shadow-[0_1px_1px_rgba(255,255,255,0.3)]">
            ...
            <span className="text-white font-semibold">Site Visit Practical</span>
          </div>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="lg:pr-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mb-8">
                    <div className="flex items-center gap-3 bg-white/70 p-3 rounded-lg border border-orange-200/50">
                        <Users className="w-6 h-6 text-[#D7281E]" />
                        <span className="font-semibold text-stone-800">Group of max 5 students</span>
                    </div>
                     <div className="flex items-center gap-3 bg-white/70 p-3 rounded-lg border border-orange-200/50">
                        <MapPin className="w-6 h-6 text-[#D7281E]" />
                        <span className="font-semibold text-stone-800">Delhi-NCR Only</span>
                    </div>
                </div>
              ...
              <div>
                {submitted && (
                  <div className="bg-green-500/10 border border-green-600 text-green-800 px-4 py-3 rounded mb-6 text-center">
                    Thank you for applying! We will contact you shortly with the schedule details.
                  </div>
                )}
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm font-semibold mb-2 text-stone-900">Location</label>
                      <input type="text" name="location" value={formData.location} onChange={handleChange} required className="w-full px-4 py-3 bg-white/70 border border-orange-200/50 rounded-lg text-stone-900 placeholder-stone-500 focus:outline-none focus:ring-2 focus:ring-[#D7281E]" />
                    </div>
                    <div>
